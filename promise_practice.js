...
//     })
var operations = [
    function () { return fetch('https://api.example.com/data1'); },
    function () { return fetch('https://api.example.com/data2'); },
    function () { return fetch('https://api.example.com/data3'); },
];
var initialValue = Promise.resolve([]);
var finalPromise = operations.reduce(function (promise, presentValue) {
    return promise.then(function (results) {
        return presentValue().then(function (data) {
            __spreadArray(__spreadArray([], results, true), [data], false);
        });
    });
}, initialValue);
